                            ...
                            {showFooterAdd && (
                              <div className="mt-1.5 space-y-1">
                                <button className="w-full text-left px-2 py-1 rounded-md bg-[#FCF7F8] border border-[#E7C9CD] text-[#6B6B6B] hover:bg-[#FBEBEE] hover:text-[#8F4A4A]00 hover:border-[#E7C9CD] transition-colors" onClick={() => {
                                  const bg = "#0A84FF";
                                  const btn: FooterButton = { id: uid("btn_"), kind: "footer_button", enabled: true, label: "新按鈕", action: { type: "uri", uri: "https://example.com" }, style: "primary", bgColor: bg, textColor: autoTextColor(bg), autoTextColor: true, width: "full" };
                                  setSection({ ...section, footer: [...((section as any).footer || []), btn].slice(0, 4) });
              ...
              {isSpecialCard && specialSection ? (
                ...
                <>
                  ...
                  <AccordionSection
                    ...
                    right={<span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#F0F0F0] text-[#2B2B2B] border border-[#E7C9CD]">{(section as any).footer?.length || 0}/4</span>}
                  >
                    <div className="space-y-3">
                      {((section as any).footer || []).map((b: any, idx: number) => (
                          ...
                          <div>
                            <div>
                              <div className="flex items-center gap-2 mb-3">
                                <div className="text-sm font-semibold text-[#555555]">排版</div>
                                <div className="flex rounded-lg overflow-hidden border border-[#E7C9CD] text-xs font-medium">
                                  <button className={`px-3 py-1.5 transition-colors ${(b.width || "full") === "full" ? "bg-[#A35D5D] text-white" : "bg-white text-[#6B6B6B] hover:bg-[#FCF7F8]"}`}
                                    onClick={() => { const next = [...(section as any).footer]; next[idx] = { ...b, width: "full" }; setSection({ ...section, footer: next }); }}>獨行</button>
                                  <button className={`px-3 py-1.5 border-l border-[#E7C9CD] transition-colors ${b.width === "half" ? "bg-[#A35D5D] text-white" : "bg-white text-[#6B6B6B] hover:bg-[#FCF7F8]"}`}
                                    onClick={() => { const next = [...(section as any).footer]; next[idx] = { ...b, width: "half" }; setSection({ ...section, footer: next }); }}>並排</button>
                                </div>
                                {b.width === "half" && (() => { const ft = (section as any).footer || []; let i = 0, ok = false; while (i < ft.length) { if (ft[i]?.width === "half" && ft[i+1]?.width === "half") { if (i === idx || i+1 === idx) { ok = true; break; } i += 2; } else { i++; } } return !ok ? <span className="text-xs text-amber-600">需與另一個並排按鈕相鄰</span> : null; })()}
                              </div>
              ...
              <>
                  ...
                  <div className="relative" style={{ width: "270px" }}>
                    <div className="rounded-[46px]" style={{ background: "#111", padding: "6px", boxShadow: "0 0 0 1px #222, 0 20px 60px rgba(0,0,0,0.5)" }}>
                      <div className="rounded-[42px] overflow-hidden flex flex-col" style={{ background: "#111", height: "559px" }}>
                        <div className="flex justify-center pt-3 pb-2 flex-shrink-0" style={{ background: "rgba(55,72,100,0.60)" }}>
                          <div style={{ width: "100px", height: "28px", background: "rgba(0,0,0,0.7)", borderRadius: "14px", border: "1.5px solid rgba(255,255,255,0.08)" }} />
                        </div>
                        <div className="flex items-center gap-2 px-3 py-1.5 flex-shrink-0" style={{ background: "rgba(55,72,100,0.60)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                        ...
                        <div className="p-2 pb-3 flex-1 overflow-y-auto min-h-0" style={{ background: "#90AACB" }}>
                        ...
                        {!isSpecialCard && (
                          <div className="pl-4">
                            <button className="flex items-center gap-1.5 py-1.5 px-2 w-full text-left rounded-lg border border-dashed border-[#E7C9CD] text-xs text-[#6B6B6B] hover:text-[#A35D5D] hover:bg-[#FBEBEE] transition-colors"
                              disabled={((section as any).footer?.length || 0) >= 4}
                              onClick={() => { const bg = "#0A84FF"; const btn: FooterButton = { id: uid("btn_"), kind: "footer_button", enabled: true, label: "新按鈕", action: { type: "uri", uri: "https://example.com" }, style: "primary", bgColor: bg, textColor: autoTextColor(bg), autoTextColor: true, width: "full" }; setSection({ ...section, footer: [...((section as any).footer || []), btn].slice(0, 4) }); }}>
                              + 新增按鈕
                            </button>
                          </div>
                        )}
            ...
            <div className="space-y-4">
              {isSpecialCard && specialSection ? (
                ...
                <>
                  ...
                  <AccordionSection title="底部按鈕" accent="bg-[#AAAAAA]"  open={open === "footer"} onToggle={() => setOpen(open === "footer" ? "hero" : "footer")} right={<span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#F0F0F0] text-[#2B2B2B] border border-[#E7C9CD]">{(section as any).footer?.length || 0}/4</span>}>
                    <div className="space-y-3">
                      <button className="w-full px-4 py-3 bg-white border border-dashed border-[#E7C9CD] rounded-xl text-[#6B6B6B] hover:bg-[#FCF7F8] hover:border-[#A35D5D] font-medium transition-all shadow-sm" disabled={((section as any).footer?.length || 0) >= 4} onClick={() => { const bg = "#0A84FF"; const btn: FooterButton = { id: uid("btn_"), kind: "footer_button", enabled: true, label: "新按鈕", action: { type: "uri", uri: "https://example.com" }, style: "primary", bgColor: bg, textColor: autoTextColor(bg), autoTextColor: true, width: "full" }; setSection({ ...section, footer: [...((section as any).footer || []), btn].slice(0, 4) }); }}>+ 新增按鈕</button>
                      {((section as any).footer || []).map((b: any, idx: number) => (
                        <div key={b.id} className="bg-white border border-[#E7C9CD] rounded-xl p-4 space-y-3 shadow-sm">
                          ...
                          <div className="flex items-center gap-2 mb-3"><div className="text-sm font-semibold text-[#555555]">排版</div><div className="flex rounded-lg overflow-hidden border border-[#E7C9CD] text-xs font-medium"><button className={`px-3 py-1.5 transition-colors ${(b.width || "full") === "full" ? "bg-[#A35D5D] text-white" : "bg-white text-[#6B6B6B] hover:bg-[#FCF7F8]"}`} onClick={() => { const next = [...(section as any).footer]; next[idx] = { ...b, width: "full" }; setSection({ ...section, footer: next }); }}>獨行</button><button className={`px-3 py-1.5 border-l border-[#E7C9CD] transition-colors ${b.width === "half" ? "bg-[#A35D5D] text-white" : "bg-white text-[#6B6B6B] hover:bg-[#FCF7F8]"}`} onClick={() => { const next = [...(section as any).footer]; next[idx] = { ...b, width: "half" }; setSection({ ...section, footer: next }); }}>並排</button></div>{b.width === "half" && (() => { const ft = (section as any).footer || []; let i = 0, ok = false; while (i < ft.length) { if (ft[i]?.width === "half" && ft[i+1]?.width === "half") { if (i === idx || i+1 === idx) { ok = true; break; } i += 2; } else { i++; } } return !ok ? <span className="text-xs text-amber-600">需與另一個並排按鈕相鄰</span> : null; })()}</div>
                ...
                <div className="rounded-[46px]" style={{ background: "#111", padding: "6px", boxShadow: "0 0 0 1px #222, 0 20px 60px rgba(0,0,0,0.5)" }}>
                  <div className="rounded-[42px] overflow-hidden flex flex-col" style={{ background: "#111", height: "559px" }}>
                    ...
                    <div className="flex items-center gap-2 px-3 py-1.5 flex-shrink-0" style={{ background: "rgba(55,72,100,0.60)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                      ...
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.75)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.75)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="18" x2="21" y2="18"/></svg>
                    </div>
                    <div className="p-2 pb-3 flex-1 overflow-y-auto min-h-0" style={{ background: "#90AACB" }}>
                      <div className="flex items-start gap-1">
                        <div className="w-6 h-6 rounded-full bg-white flex-shrink-0 flex items-center justify-center overflow-hidden mt-1">
