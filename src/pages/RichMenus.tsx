      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden" onClick={e => e.stopPropagation()}>
        ...
        <form onSubmit={handleCreate} className="px-6 py-5">
          ...
          <input
            ...
            className="w-full rounded-xl border border-[#E7C9CD] bg-white px-4 py-3 text-sm text-[#2B2B2B] placeholder-[#C4A8AB] focus:outline-none focus:ring-2 focus:ring-[#A35D5D] focus:border-[#A35D5D] transition"
          />
          <div className="mt-3 bg-[#F0F7FF] rounded-xl px-4 py-3 text-xs text-[#4A7BAF]">
            <p className="font-medium mb-0.5">多層圖文選單</p>
            <p className="text-[#6B8FAF]">支援多個選單層，透過按鈕動作在選單間切換，打造豐富的互動體驗。</p>
          </div>
              ...
              <tr>
                <td colSpan={6} className="py-24 text-center">
                  <div className="flex flex-col items-center justify-center opacity-70">
                    <div className="w-16 h-16 bg-[#EEF4FF] rounded-full flex items-center justify-center mb-4">
